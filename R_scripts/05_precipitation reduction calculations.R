...
# this code loops through days_before_vec and creates output for
# each 
days_before_vec <- c(365, 730, 1095, 1460)
...
for(days_before in days_before_vec){
...
} # end looping throug days_before_vec