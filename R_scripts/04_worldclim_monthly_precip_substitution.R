...
latlon$Jan <- extract(p01,latlon[,2:3])
latlon$Feb <- extract(p02,latlon[,2:3])
latlon$Mar <- extract(p03,latlon[,2:3])
latlon$Apr <- extract(p04,latlon[,2:3])
latlon$May <- extract(p05,latlon[,2:3])
latlon$Jun <- extract(p06,latlon[,2:3])
latlon$Jul <- extract(p07,latlon[,2:3])
latlon$Aug <- extract(p08,latlon[,2:3])
latlon$Sep <- extract(p09,latlon[,2:3])
latlon$Oct <- extract(p10,latlon[,2:3])
latlon$Nov <- extract(p11,latlon[,2:3])
latlon$Dec <- extract(p12,latlon[,2:3])
